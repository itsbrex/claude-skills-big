...
Generate the `ai-readiness-report.md` file using the structure below. The output must be thorough, professional, and actionable. Fill every bracketed placeholder with assessment-specific content.
